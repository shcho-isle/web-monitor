...
public class ConfigTestData {
    ...
    public static final UrlConfig TEST_CONFIG1 = new UrlConfig(CONFIG_ID1, "http://www.starwars.com/", 100, 10_000, 20_000, 200, 1, 10_000_000, null);
    public static final UrlConfig TEST_CONFIG2 = new UrlConfig(CONFIG_ID2, "https://igov.org.ua/", 2, 2, 2, 2, 2, 2, "substring2");
    ...
    public static void populateWithTestData(ConfigRepository repository) {
        repository.save(new UrlConfig(null, "http://www.starwars.com/", 100, 10_000, 20_000, 200, 1, 10_000_000, null));
        repository.save(new UrlConfig(null, "https://igov.org.ua/", 2, 2, 2, 2, 2, 2, "substring2"));
    }

    public static UrlConfig getCreated() {
        return new UrlConfig(null, "http://www.i.ua/", 3, 3, 3, 3, 3, 3, "");
    }

    public static UrlConfig getUpdated() {
        return new UrlConfig(CONFIG_ID1, "http://hh.ua/", 4, 4, 4, 4, 4, 4, "updated substring");
    }

    public static UrlConfig getTestConfig() {
        return new UrlConfig(CONFIG_ID1, "http://www.starwars.com/", 100, 10_000, 20_000, 200, 1, 10_000_000, null);
    }
}
