...
<script type="text/javascript">
    var criticals = document.getElementsByClassName("CRITICAL");
    var warnings = document.getElementsByClassName("WARNING");
    var snd;

    if (criticals.length !== 0)
        snd = new Audio('data:audio/wav;base64,UklGRl9vT19XQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YU' + new Array(1e3).join(123));
